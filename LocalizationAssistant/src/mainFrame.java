...
public class mainFrame extends JFrame implements ActionListener{
	...
	//在构造方法中实现LA所有GUI的布置
	public mainFrame(){
		super("Localization Assistant v1.0");
		setSize(480,540);
		...
		//Labels
		label1_1 = new JLabel();
		label1_1.setText("<html><body>作者:JJN(GWYOG)<br/>版本号:v1.0<br/>日期:2016/4/27</body></html>");
		...
		//Lists
		String[] listInitial ={"等待输入"};
		list1 = new JList(listInitial);
		list2 = new JList(listInitial);
